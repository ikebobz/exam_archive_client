...
public final class SubjectDao_Impl implements SubjectDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfDeleteByExam;
  ...
  public SubjectDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfSubjectEntity = new EntityInsertionAdapter<SubjectEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `subjects` (`id`,`examId`,`name`,`code`,`description`,`createdAt`,`updatedAt`) VALUES (?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(2, entity.getExamId());
    ...
    this.__preparedStmtOfDeleteByExam = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "DELETE FROM subjects WHERE examId = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object insertAll(final List<SubjectEntity> subjects,
  ...
  @Override
  public Object replaceAll(final List<SubjectEntity> subjects,
      final Continuation<? super Unit> $completion) {
    return RoomDatabaseKt.withTransaction(__db, (__cont) -> SubjectDao.DefaultImpls.replaceAll(SubjectDao_Impl.this, subjects, __cont), $completion);
  }

  @Override
  public Object replaceByExam(final int examId, final List<SubjectEntity> subjects,
      final Continuation<? super Unit> $completion) {
    return RoomDatabaseKt.withTransaction(__db, (__cont) -> SubjectDao.DefaultImpls.replaceByExam(SubjectDao_Impl.this, examId, subjects, __cont), $completion);
  }
  ...
  @Override
  public Object deleteByExam(final int examId, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfDeleteByExam.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfDeleteByExam.release(_stmt);
        }
      }
    }, $completion);
  }
      ...
      public List<SubjectEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new SubjectEntity(_tmpId,_tmpExamId,_tmpName,_tmpCode,_tmpDescription,_tmpCreatedAt,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<List<SubjectEntity>> getSubjectsByExam(final int examId) {
    final String _sql = "SELECT * FROM subjects WHERE examId = ? ORDER BY name ASC";
  ...
  @Override
  public Object getSubjectsByExamList(final int examId,
      ...
      public SubjectEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpUpdatedAt;
            _tmpUpdatedAt = _cursor.getString(_cursorIndexOfUpdatedAt);
            _result = new SubjectEntity(_tmpId,_tmpExamId,_tmpName,_tmpCode,_tmpDescription,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
