...
public final class QuestionDetailViewModel_Factory implements Factory<QuestionDetailViewModel> {
  ...
  public QuestionDetailViewModel_Factory(Provider<QuestionRepository> questionRepositoryProvider,
  ...
  public static QuestionDetailViewModel_Factory create(
      ...
      Provider<ExamRepository> examRepositoryProvider,
      Provider<SavedStateHandle> savedStateHandleProvider) {
    return new QuestionDetailViewModel_Factory(questionRepositoryProvider, subjectRepositoryProvider, examRepositoryProvider, savedStateHandleProvider);
  }

  public static QuestionDetailViewModel newInstance(QuestionRepository questionRepository,
      SubjectRepository subjectRepository, ExamRepository examRepository,
      SavedStateHandle savedStateHandle) {
    return new QuestionDetailViewModel(questionRepository, subjectRepository, examRepository, savedStateHandle);
  }
}
